...
#tau = torch.Tensor([0,0,0,0.5,0,0,0,1.1]) #Ravesh 8/14/2023: Tried to modify the jaw closing.  Original is to not specify a tau vector
...
command_layer._params["b"].data[2] = 3 * R
...
command_layer._params["erev"].data[3, 2] = -3 * R
...
#tau = torch.Tensor([0.1, 0.1, 0.1, 1.1]) #tried to slow down jaws
tau = torch.Tensor([0.1, 0.3, 0.1, 0.3]) #original
