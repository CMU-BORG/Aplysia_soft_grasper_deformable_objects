...
To align point clouds, enter the .obj of the pre- and post- grasp point clouds in [Deformable Object Analysis/ScanMap_<Fruits, PlayDoh>.xlsx].  Then, run [Deformable Object Analysis/Process_visualize_scans.py] to batch align, generate figures and videos, and compute Chamfer Distance for the different experiments. The .obj files and datalogs for the deformable grasping experiments and the noise immunity tests on the robot are available at [10.5281/zenodo.18637792](https://doi.org/10.5281/zenodo.18637792). 
